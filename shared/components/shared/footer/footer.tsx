...
import { ContactsData } from "@/shared/models/contacts";
      ...
      <div className="footer__content">
        ...
        <div className="footer__content-columnContacts">
          ...
          <div className="contact">
            ...
            <Link href="" className="contact__row">
              ...
              <span className="contact__text">Политика конфиденциальности</span>
            </Link>
            <Link href="" className="contact__row">
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                <path
              ...
              <span className="contact__text">Пользовательское соглашение</span>
            </Link>
          </div>
        </div>
        </div>
